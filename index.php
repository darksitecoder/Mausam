...
if (isset($_POST['submit'])) {
   $city = $_POST['city'];
   $url = "http://api.openweathermap.org/data/2.5/weather?q=$city&appid=332117f9f052c17e2ffa591e72533d49";
   $ch = curl_init();
...
<head>
   ...
   <style>
      ...
      body {
         background: url(https://source.unsplash.com/1600x900/?weather,dark);
